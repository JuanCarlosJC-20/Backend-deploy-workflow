...
{
    throw new InvalidOperationException("Jwt:Key no está configurado. Por favor, establece la variable de entorno Jwt__Key");
}
...
Console.WriteLine($"🚀 Aplicación escuchando en puerto: {port}");
